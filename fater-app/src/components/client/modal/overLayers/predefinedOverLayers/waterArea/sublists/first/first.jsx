...
import VerticalTabWithList from "../../../verticalTabWithList/verticalTabWithList";
import "ol/ol.css";
...
import {
  groupedOptions,
  lakesOptions,
} from "../../configuration/lacksAndDamsOptions";
    ...
    tabs: [
      {
        ...
        satellites: [satellites.amsr2, satellites.gfs, satellites.sentinel3],
