...
class DeleteCustomOverLayersModal extends Component {
  notify = (message, type) => {
    if (type === "error") {
      toast.error(`${message}`, {
        autoClose: 10000,
    ...
    if (window.localStorage.access_token) {
      $.ajax({
        ...
        success: function (response) {
          ...
          notif("Succeful! File Deleted", "success");
        },
        error: function (err) {
          $("#deleteModal").modal("hide");
          notif("Failed! File did not Deleted", "error");
        },
      });
    }
  };
...
export default DeleteCustomOverLayersModal;
